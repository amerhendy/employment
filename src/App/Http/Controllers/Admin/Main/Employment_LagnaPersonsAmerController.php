...
class Employment_LagnaPersonsAmerController extends AmerController
{
    ...
    public function setup()
    {
        ...
        if(amer_user()->can('Employment_LagnaPersons-add') == 0){$this->Amer->denyAccess('create');}
        if(amer_user()->can('Employment_LagnaPersons-trash') == 0){$this->Amer->denyAccess ('trash');}
        if(amer_user()->can('Employment_LagnaPersons-update') == 0){$this->Amer->denyAccess('update');}
        if(amer_user()->can('Employment_LagnaPersons-delete') == 0){$this->Amer->denyAccess('delete');}
        if(amer_user()->can('Employment_LagnaPersons-show') == 0){$this->Amer->denyAccess('show');}
        */
    }
