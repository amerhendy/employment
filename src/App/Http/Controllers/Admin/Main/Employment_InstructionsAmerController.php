...
class Employment_InstructionsAmerController extends AmerController
{
    ...
    public function setup()
    {
        ...
        if(amer_user()->can('Employment_Instructions-add') == 0){$this->Amer->denyAccess('create');}
        if(amer_user()->can('Employment_Instructions-trash') == 0){$this->Amer->denyAccess ('trash');}
        if(amer_user()->can('Employment_Instructions-update') == 0){$this->Amer->denyAccess('update');}
        if(amer_user()->can('Employment_Instructions-delete') == 0){$this->Amer->denyAccess('delete');}
        if(amer_user()->can('Employment_Instructions-show') == 0){$this->Amer->denyAccess('show');}
        */
    }
