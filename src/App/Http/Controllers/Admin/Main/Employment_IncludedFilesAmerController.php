...
class Employment_IncludedFilesAmerController extends AmerController
{
    ...
    public function setup()
    {
        ...
        if(amer_user()->can('Employment_IncludedFiles-add') == 0){$this->Amer->denyAccess('create');}
        if(amer_user()->can('Employment_IncludedFiles-trash') == 0){$this->Amer->denyAccess ('trash');}
        if(amer_user()->can('Employment_IncludedFiles-update') == 0){$this->Amer->denyAccess('update');}
        if(amer_user()->can('Employment_IncludedFiles-delete') == 0){$this->Amer->denyAccess('delete');}
        if(amer_user()->can('Employment_IncludedFiles-show') == 0){$this->Amer->denyAccess('show');}
        */
    }
