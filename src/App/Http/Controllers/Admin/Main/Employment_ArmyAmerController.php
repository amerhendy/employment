...
class Employment_ArmyAmerController extends AmerController
{
    ...
    public function setup()
    {
        ...
        if(amer_user()->can('Employment_Army-add') == 0){$this->Amer->denyAccess('create');}
        if(amer_user()->can('Employment_Army-trash') == 0){$this->Amer->denyAccess ('trash');}
        if(amer_user()->can('Employment_Army-update') == 0){$this->Amer->denyAccess('update');}
        if(amer_user()->can('Employment_Army-delete') == 0){$this->Amer->denyAccess('delete');}
        if(amer_user()->can('Employment_Army-show') == 0){$this->Amer->denyAccess('show');}
        */
    }
