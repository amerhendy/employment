...
class Employment_HealthAmerController extends AmerController
{
    ...
    public function setup()
    {
        ...
        if(amer_user()->can('Employment_Health-add') == 0){$this->Amer->denyAccess('create');}
        if(amer_user()->can('Employment_Health-trash') == 0){$this->Amer->denyAccess ('trash');}
        if(amer_user()->can('Employment_Health-update') == 0){$this->Amer->denyAccess('update');}
        if(amer_user()->can('Employment_Health-delete') == 0){$this->Amer->denyAccess('delete');}
        if(amer_user()->can('Employment_Health-show') == 0){$this->Amer->denyAccess('show');}
        */
    }
