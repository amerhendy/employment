...
class Employment_QualificationsAmerController extends AmerController
{
    ...
    public function setup()
    {
        ...
        if(amer_user()->can('Employment_Qualifications-add') == 0){$this->Amer->denyAccess('create');}
        if(amer_user()->can('Employment_Qualifications-trash') == 0){$this->Amer->denyAccess ('trash');}
        if(amer_user()->can('Employment_Qualifications-update') == 0){$this->Amer->denyAccess('update');}
        if(amer_user()->can('Employment_Qualifications-delete') == 0){$this->Amer->denyAccess('delete');}
        if(amer_user()->can('Employment_Qualifications-show') == 0){$this->Amer->denyAccess('show');}
        */
    }
