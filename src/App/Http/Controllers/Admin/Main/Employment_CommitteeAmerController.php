...
class Employment_CommitteeAmerController extends AmerController
{
    ...
    public function setup()
    {
        ...
        if(amer_user()->can('Employment_Committee-add') == 0){$this->Amer->denyAccess('create');}
        if(amer_user()->can('Employment_Committee-trash') == 0){$this->Amer->denyAccess ('trash');}
        if(amer_user()->can('Employment_Committee-update') == 0){$this->Amer->denyAccess('update');}
        if(amer_user()->can('Employment_Committee-delete') == 0){$this->Amer->denyAccess('delete');}
        if(amer_user()->can('Employment_Committee-show') == 0){$this->Amer->denyAccess('show');}
        */
    }
