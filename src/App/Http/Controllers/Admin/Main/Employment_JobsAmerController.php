...
class Employment_JobsAmerController extends AmerController
{
    ...
    public function setup()
    {
        ...
        if(amer_user()->can('Employment_Jobs-add') == 0){$this->Amer->denyAccess('create');}
        if(amer_user()->can('Employment_Jobs-trash') == 0){$this->Amer->denyAccess ('trash');}
        if(amer_user()->can('Employment_Jobs-update') == 0){$this->Amer->denyAccess('update');}
        if(amer_user()->can('Employment_Jobs-delete') == 0){$this->Amer->denyAccess('delete');}
        if(amer_user()->can('Employment_Jobs-show') == 0){$this->Amer->denyAccess('show');}
        */
    }
