...
<html lang="{{config('amer.lang') ?? 'ar-eg'}}" dir="{{config('amer.lang') ?? 'rtl'}} " prefix="{{config('amer.co_name') ?? 'HCWW'}}" data-bs-theme="auto">
    ...
    jstrans['apiReciveData']="{{trans('AMER::errors.apiReciveData')}}";
    ...
    jstrans['Employment_StartAnnonces']={{ Illuminate\Support\Js::from(trans('JOBLANG::Employment_StartAnnonces')) }};
