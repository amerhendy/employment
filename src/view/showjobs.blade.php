...
<script type="application/javascript">
    jstrans['name']="{{trans('jobs.name')}}";
    jstrans['job_name']="{{trans('jobs.job_name')}}";
    jstrans['job_description']="{{trans('jobs.job_description')}}";
    jstrans['count']="{{trans('jobs.count')}}";
    jstrans['khebra']="{{trans('jobs.khebra')}}";
    jstrans['category']="{{trans('jobs.functional_id')}}";
    //jstrans['apply_edU_any_of']="{{trans('education.apply_edU_any_of')}}";
    jstrans['private_qual']="{{trans('qualifications.private_qual')}}";
    jstrans['age']="{{trans('jobs.age')}}";
    jstrans['age_in']="{{trans('jobs.age_in')}}";
    jstrans['included_files']="{{trans('included_files.included_files')}}";
