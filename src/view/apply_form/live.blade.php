...
<div class="row text-right border-bottom"  id='lp'>
            ...
            <div class="md-form input-group">
                ...
                <div class="md-form  w-100" id='LiveAddress_div'  style='display:none';>
                    <input type="text" class="form-control"  name="LiveAddress" id="LiveAddress" onblur='trim(this)' placeholder="{{trans('JOBLANG::Employment_People.LivePlace.Address')}}" value="{{old('LiveAddress')?? $data->value->LiveAddress}}">
                </div>
            </div>
            </div>
