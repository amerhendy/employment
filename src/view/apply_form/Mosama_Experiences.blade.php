<!-- khebr -->
<div class="row text-right border-bottom" id='div_Khebra'>
            ...
            <div class='col col-lg'>
                ...
                ?>
                <select id="Khebra_type" name="Khebra_type" class="form-control w-100" placeholder="{{trans('JOBLANG::Employment_People.Khebra.type')}}" value="{{old('Khebra_type') ?? $data->value->Khebra[0]}}" >
                ...
                <input type="number" name="Khebra" class="form-control w-100"  onblur='trim(this)' placeholder="{{trans('JOBLANG::Employment_People.Khebra.years')}}" value="{{old('Khebra') ?? (int)$data->value->Khebra[1]}}" minlen='1'>
            </div>
