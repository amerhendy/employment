...
@section('content')
   ...
   <div class="container omg">
        ...
        @csrf
            ...
            ?>
            <input type="hidden" data-init-function='set_current_date_time' name="apply_date" id="apply_date" value=''>
            <div id='hiddens' data='{{$annonce}}' jb='{{$job}}'></div>
            <input type="hidden" value="{{$annonce}}" name="annonce_id" id="annonce_id">
            <input type="hidden" value="{{$job}}" name="job_id" id="job_id">
            ...
            @else
                <input type="hidden" value="apply" name="actiontype" id="actiontype">
