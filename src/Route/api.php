...
use Illuminate\Support\Facades\Auth;
    ...
    Route::post('employment/getjob/{annslug}/{jobslug}/','api\AnnoncesController@getjob_by_job_slug');
    Route::post('employment/getjob/{annslug}','api\AnnoncesController@getjob_by_Annonce_slug');
    Route::post('employment/checknid/{an_slug}/{jbslug}','api\nidController@employment_apply_checknid');       //checked
    ...
    Route::post('QRCODE','api\AnnoncesController@qrbytext'); /// qrcode        //checked
    Route::post('employment_operation/stage/{annid}/{jobid}/{process}/check', 'api\ApplyController@applycheck')->name('apply_check');
    Route::post('employment/getresult/{ann_id}','api\searchController@get_result');
    ///Employment Reports
