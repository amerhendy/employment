...
Route::post('employment_operation/annoncejobinfo/{annid}/{jobid}', 'apply@getannonce_job_info')->name('jobinfo');
    ...
    Route::post('/employment_operation/stage/{annid}/{jobid}/{process}/submit', 'apply@applyStore')->name('apply_store');
    Route::post('/employment_operation/stage/{annid}/{jobid}/{nid}/apply-review', 'apply@review')->name('afterApply_review');
    Route::post('/employment_operation/stage/{annid}/{jobid}/{nid}/complete-review', 'apply@review')->name('afterComplete_review');
});